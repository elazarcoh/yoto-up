...
class PlaylistsPage(Component):
    ...
    def render(self):
        return d.Div()(
            ...
            d.Div(
                id="list-loading",
                classes="htmx-indicator flex items-center justify-center space-x-2 py-8",
            )(
                d.Div(
                    classes="animate-spin h-6 w-6 border-2 border-indigo-500 rounded-full border-t-transparent"
                ),
...
class PlaylistListPartial(Component):
    ...
    def render(self):
        ...
        return d.Div(
            classes="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 xl:grid-cols-8 gap-3"
...
def _render_playlist_card(card: Card):
    ...
    if card.metadata:
        category = (
            card.metadata.get("category", "Uncategorized")
            if isinstance(card.metadata, dict)
            else getattr(card.metadata, "category", "Uncategorized") or "Uncategorized"
        )
    ...
    if card.metadata:
        ...
        if isinstance(metadata, dict):
            ...
            if isinstance(cover_data, dict):
                cover_url = (
                    cover_data.get("imageL") or cover_data.get("imageM") or cover_data.get("imageS")
                )
        else:
            # Try as object
    ...
    return d.Div(
        classes="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow flex flex-col h-full"
    )(
        d.Div(classes="aspect-square bg-gray-200 relative overflow-hidden group")(
            ...
            if cover_url
                ...
                classes="w-full h-full flex items-center justify-center text-2xl text-gray-400"
            )("🎵"),
            ...
            d.A(
                ...
                d.Span(classes="bg-white/90 rounded-full p-2 shadow-lg text-indigo-600 text-sm")(
                    "👁️"
                )
            ),
        ),
        ...
        d.Div(
            classes="p-1 bg-gray-50 border-t border-gray-200 flex justify-between items-center gap-1"
        )(
            d.A(
                href=f"/playlists/{card_id}",
...
class PlaylistCard(Component):
    ...
    def render(self):
        ...
        title = (
            self.card.title if hasattr(self.card, "title") else self.card.get("title", "Untitled")
        )
        ...
        return d.Div(
            classes="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow flex flex-col"
        )(
            d.Div(classes="aspect-square bg-gray-200 relative overflow-hidden group")(
                d.Img(src=cover_url, alt=title, classes="w-full h-full object-cover")
                if cover_url
                else d.Div(
                    classes="w-full h-full flex items-center justify-center text-4xl text-gray-400"
                )("🎵"),
                # Overlay with view button
                d.A(
                    href=f"/playlists/{card_id}",
            ...
            d.Div(
                classes="p-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center"
            )(
                d.A(
                    href=f"/playlists/{card_id}",
    ...
    def render(self):
        ...
        return d.Div(
            ...
            **{"data-playlist-id": self.card.cardId},
            ...
            d.Div(classes="bg-white shadow-lg rounded-lg overflow-hidden")(
                ...
                d.Div(id="uploading-section", classes="border-t border-gray-200 hidden")(
                    d.Div(classes="px-6 py-6 sm:px-8")(
                        d.H3(classes="text-xl leading-6 font-bold text-gray-900 mb-4")(
                            "⬆️ Uploading"
                        ),
            ...
            d.Div(
                id="upload-modal",
                classes="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4",
            )(
                d.Div(
                    classes="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
                )(
                    # Modal header
                    d.Div(
